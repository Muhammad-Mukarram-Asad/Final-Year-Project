...
const EditProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await apiHit
      .put("/updateloginuser", userData)
      .then((response) => {
        console.log(
          "response.data after updating user details:  ",
          response.data
        );
        setData({
          name: "",
  ...
  return (
    <main className={styles["signUp_main_div"]}>
      <div className={styles["heading_div"]}>
        <img src={back_icon} alt="back_arrow" onClick={() => navigate(-1)} />
        <h1>Edit Profile</h1>
        <p>{""}</p>
      </div>
      <form onSubmit={handleSubmit}>
        ...
        <div className={styles["gender_main_div"]}>
          <label htmlFor="gender">Specify your Gender: </label>
