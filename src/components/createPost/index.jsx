...
const CreatePost = () => {
  ...
  return (
    <main className={styles["createPost"]}>
        ...
        <ul>
            <li> <input type='radio' name="format" value={"T20"} onChange={(e) => setMatchFormat(e.target.value)}/> T20</li>
            <li> <input type='radio' name="format" value={"ODI"} onChange={(e) => setMatchFormat(e.target.value)}/> ODI</li>
            <li> <input type='radio' name="format" value={"Test"} onChange={(e) => setMatchFormat(e.target.value)}/> Test</li>
        </ul>

        <div className={styles["runs_div"]}>
            <h3>Enter RUNS/WICKETS</h3>
            <input type="number" placeholder="Enter Runs/Wickets" onChange={(e) => setRuns(e.target.value)} />
        </div>
